...
describe("parseStandardCSV", () => {
  it("parses valid CSV and derives period from min/max dates", () => {
    const csv = `date,instrument_description,type,quantity,currency,unit_price
2024-01-15,AAPL - Apple Inc.,BUYSTOCK,10,USD,185.50
2024-01-10,MSFT - Microsoft,SELLSTOCK,-5,USD,398.20`;
...
2024-01-01,"Apple, Inc. - AAPL",BUYSTOCK,10`;
  ...
  it("allows optional currency and unit_price to be omitted", () => {
    const csv = `date,instrument_description,type,quantity
2024-01-01,AAPL,BUYSTOCK,10`;
    ...
    expect([undefined, ""]).toContain(result.txs[0].currency);
  });
