...
export async function importCorporateEventSplits(
  ...
  const events = rows.map((r) =>
    create(ImportCorporateEventRowSchema, {
      ...
      assetClass: r.assetClass ?? AssetClass.ASSET_CLASS_UNSPECIFIED,
      event: {
        case: "split",
