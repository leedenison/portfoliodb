...
For instrument resolution, JRNLFUND is treated as security type hint Cash and JRNLSEC as Stock. Transaction types that are not stored (e.g. **TxType** SPLIT) are dropped on upload.
