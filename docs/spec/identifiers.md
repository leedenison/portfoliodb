...
Winner selection has three tiers in order: agreeing with something a source stated, then agreeing with something a plugin proposed, then precedence alone. A proposal can break a tie among plugins that all answered; it can never outrank a statement, and a contradicted proposal costs a result its place in the middle tier and nothing more. See adr/0057-a-proposed-identifier-is-not-evidence.md.
