...
SELECT 'e2e00000-0000-0000-0000-000000000001', 'FIDELITY', 'ACC-1',
       now() - INTERVAL '5 days', now() - INTERVAL '5 days', 'USD', ARRAY['INCOME'], 'INCOME', -137.08, 'USD', 'USD', i.instrument_id, 'IMBALANCE', 'RESIDUAL',
...
INSERT INTO txs (user_id, broker, account, order_date, trade_date, instrument_description,
                 ...
                 synthetic_purpose, weight, weight_commodity, group_id)
SELECT 'e2e00000-0000-0000-0000-000000000001', 'FIDELITY', 'ACC-1',
       now() - INTERVAL '6 days', now() - INTERVAL '6 days', 'USD', ARRAY['TRADE_ASSET'], 'TRADE_ASSET', 4.95, 'USD', 'USD', i.instrument_id, 'IMBALANCE', 'RESIDUAL',
...
SELECT 'e2e00000-0000-0000-0000-000000000001', 'SCHB', v.account,
       now() - (v.days || ' days')::INTERVAL, now() - (v.days || ' days')::INTERVAL, 'USD', ARRAY['TRANSFER'], 'TRANSFER', v.qty, 'USD', 'USD',
...
SELECT 'e2e00000-0000-0000-0000-000000000001', 'IBKR', 'U-OLD',
       now() - INTERVAL '40 days', now() - INTERVAL '40 days', 'USD', ARRAY['TRANSFER'], 'TRANSFER', 500.00, 'USD', 'USD', i.instrument_id, 'TRANSFER_CLEARING', 'RESIDUAL',
...
SELECT 'e2e00000-0000-0000-0000-000000000001', 'IBKR', 'U-NEW',
       now() - INTERVAL '2 days', now() - INTERVAL '2 days', 'USD', ARRAY['TRANSFER'], 'TRANSFER', 250.00, 'USD', 'USD', i.instrument_id, 'TRANSFER_CLEARING', 'RESIDUAL',
...
SELECT 'e2e00000-0000-0000-0000-000000000001', v.broker, v.account,
       now() - (v.days || ' days')::INTERVAL, now() - (v.days || ' days')::INTERVAL, 'USD', ARRAY[v.tx_type], v.tx_type, v.qty, 'USD', 'USD',
