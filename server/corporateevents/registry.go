...
// Registry holds corporate event plugin implementations by plugin ID.
// The orchestrator loads enabled plugins (with precedence and config) from
// the DB, then looks them up here to invoke FetchEvents.
