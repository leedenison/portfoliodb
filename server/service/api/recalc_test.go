...
func padEq(qty string, basis time.Time) gomock.Matcher {
	return padMatcher{qty: decimal.RequireFromString(qty)}
}
...
func (m padMatcher) Matches(x any) bool {
	...
	return got.Quantity.Equal(m.qty)
}

func (m padMatcher) String() string {
	return fmt.Sprintf("is a pad of %s", m.qty)
}
...
func testDecl(id, instrumentID, declaredQty string) *db.HoldingDeclarationRow {
	return &db.HoldingDeclarationRow{
		...
		DeclaredQty: declaredQty, AsOfDate: testAsOf}
}
...
func TestRecalcAllInitializeTxs_RecomputesQty(t *testing.T) {
	...
	mockDB.EXPECT().ComputeRunningBalance(gomock.Any(), "user-1", "IBKR", "acct1", "inst-1", gomock.Any(), gomock.Any(), gomock.Any()).Return(decimal.NewFromInt(40), nil)
...
func TestRecalcAllInitializeTxs_RecalcsEachHolding(t *testing.T) {
	...
	mockDB.EXPECT().GetPortfolioStartDate(gomock.Any(), "user-1").Return(&startDate, nil)
	mockDB.EXPECT().ListInstrumentsByIDs(gomock.Any(), gomock.Any()).Return(nil, nil)
	mockDB.EXPECT().ComputeRunningBalance(gomock.Any(), "user-1", "IBKR", "acct1", "inst-1", gomock.Any(), gomock.Any(), gomock.Any()).Return(decimal.NewFromInt(20), nil)
	mockDB.EXPECT().ConvertQtyToBasis(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).DoAndReturn(func(_ context.Context, _ string, q decimal.Decimal, _, _ time.Time) (decimal.Decimal, error) {
		return q, nil
	}).AnyTimes()
	mockDB.EXPECT().UpsertInitializeTx(gomock.Any(), "user-1", "IBKR", "acct1", "inst-1", padEq("80", testBasis)).Return(nil)
	mockDB.EXPECT().ComputeRunningBalance(gomock.Any(), "user-1", "IBKR", "acct1", "inst-2", gomock.Any(), gomock.Any(), gomock.Any()).Return(decimal.NewFromInt(10), nil)
	mockDB.EXPECT().ConvertQtyToBasis(gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any(), gomock.Any()).DoAndReturn(func(_ context.Context, _ string, q decimal.Decimal, _, _ time.Time) (decimal.Decimal, error) {
		return q, nil
	}).AnyTimes()
