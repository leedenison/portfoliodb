...
func TestRouteResiduals(t *testing.T) {
	...
	cases := []struct {
		...
		want: []routed{
			{commodity: "USD", quantity: "-25", accountType: typev1.AccountType_ACCOUNT_TYPE_IMBALANCE},
			{commodity: aaplID, quantity: "-10", accountType: typev1.AccountType_ACCOUNT_TYPE_IMBALANCE},
		},
	}, {
